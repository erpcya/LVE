 ...
 */
public class AraureImpuestoMunicipal_TXT extends ExportFormatCSV {
	
	public AraureImpuestoMunicipal_TXT(Properties ctx, ReportEngine reportEngine) {
		super(ctx, reportEngine);
	}
	
	/**	Static Logger	*/
	private static CLogger	log	= CLogger.getCLogger (AraureImpuestoMunicipal_TXT.class);
	...
	public String getName() {
		return Msg.getMsg(Env.getCtx(), "FileIMAraureTXT");
	}
